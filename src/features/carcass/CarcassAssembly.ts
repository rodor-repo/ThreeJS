  ...
  public getPartDimensions(): Array<{
    ...
    if (this.cabinetType === "filler") {
      if (this.frontPanel) {
        ...
        const frontPanelGeometry = this.frontPanel.mesh.geometry as THREE.BoxGeometry
        parts.push({
      ...
      if (this.fillerReturn) {
        // CarcassPanel: Get actual dimensions from geometry
        const returnGeometry = this.fillerReturn.mesh.geometry as THREE.BoxGeometry
        parts.push({
    ...
    if ((this.cabinetType === "base" || this.cabinetType === "tall" || this.cabinetType === "wardrobe") && this.bottom) {
